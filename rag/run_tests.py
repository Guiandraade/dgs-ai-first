...
TESTS = [
    {
        ...
        "armadilha": "Não deve dizer que carga perigosa tem 7 dias de prazo",
    },
    {
        "id": "P2",
        "pergunta": "Posso devolver carga perigosa? Qual o procedimento?",
        "fontes_esperadas": ["POL-001-politica-devolucao"],
    ...
    },
    {
        ...
        "armadilha": "Inventar SLA para Platinum é alucinação pura. SLA-2024 diz explicitamente que só existem 3 tiers.",
    },
    {
        "id": "P5",
        "pergunta": "Quanto custa o frete especial para 600kg com destino a Manaus?",
        "fontes_esperadas": ["PROC-042-v2-frete-especial-revisado"],
        "descricao": "Conflito v1 vs v2 — multiplicador Norte: 1.6 (v1) vs 1.8 (v2)",
    ...
    },
    {
        ...
        "fontes_esperadas": [],
        "descricao": "Não-cobertura documental — frete padrão (<500kg) não está nos documentos",
