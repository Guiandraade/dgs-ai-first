# Evidencias - Fase 3 (Governanca e Validacao)

Este arquivo indexa as evidencias de execucao e revisao dos exercicios 3.1 e 3.2.

## Evidencias coletadas

| ID | Evidencia | Arquivo | Exercicios vinculados | Observacao |
|---|---|---|---|---|
...
1. Anexar print/export de chat com iteracoes do Copilot para 3.1 (geracao inicial + correcoes).
2. Anexar print/export de chat com revisao do Claude para 3.2.
3. Se houver mais capturas, manter padrao de nome: `captura-governanca-YYYY-MM-DD-HHMMSS.ext`.
